...
public class PracticaPSP1 extends JFrame
{
	...
	public PracticaPSP1()
	{
		...
		bReloj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Process proceso =runtime.exec("java -jar \"C:\\Users\\migue\\Reloj.jar");
					long pid = proceso.pid();      
					listModel.addElement("Reloj "+ pid);
					list.setSelectedValue("Reloj "+ pid,true);
				
					bReloj.setEnabled(false);
				} catch (IOException e1) {
					e1.printStackTrace();
				}
			}
